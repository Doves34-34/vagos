...
# MongoDB connection
client = MongoClient("mongodb+srv://EMDBUSER:GdtCXD46tdder4@cluster0.wkv7cqk.mongodb.net/?retryWrites=true&w=majority")
db = client["vagos_db"]
...
def index():
    ...
    # If user has an active order, show it
    if active_order:
        return render_template('current_order.html', order=active_order)

    # Otherwise allow them to place a new order
